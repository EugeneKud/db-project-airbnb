...
namespace DbProjectAirbnb.Web.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CountryId")] City city)
        {
            ...
            ViewData["CountryId"] = new SelectList(_context.Countries, "Id", "Code", city.CountryId);
            return View(city);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,CountryId")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
